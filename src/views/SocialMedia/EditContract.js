...
class AddInvestment extends React.Component{
    ...
    componentDidMount(){
        makeRequest(this.props).get('/social-media/get/'+this.props.params.id)
            .then(response => {
            this.setState({
                    id: response.data.data.contract.id,
                    client: response.data.data.contract.client,
                    campaign_name: response.data.data.contract.campaign_name,
                    budget: response.data.data.contract.budget,
                    media_targets: response.data.data.contract.media_targets,
                    start_date: response.data.data.contract.start_date,
                    end_date: response.data.data.contract.end_date,
                })
            })
            .catch(error => {
                handleError({
    ...
    handleCreate = (event) =>{
        this.props.openDialog({
            viewCtrl: "warning",
            title: "Confirm Social Media Campaign Update",
            ...
            confirm: dialog =>{
                makeRequest(this.props).post('/social-media/update/'+this.props.params.id, qs.stringify(this.state))
                    .then(response => {
